    ...
    <div className="relative z-50 flex flex-col items-center justify-center h-full px-6 text-center pointer-events-none">
      <Motion.div
        ...
        <div className="relative mt-4 space-y-8">
          ...
          <div className="hidden md:flex items-center justify-center w-full text-2xl md:text-[4rem] gap-5 mx-auto mt-5 md:gap-10 max-w-7xl min-h-140px md:min-h-180px">
