    ...
    <div
      ...
      <svg className="absolute inset-0 w-full h-full" xmlns="http://www.w3.org/2000/svg">
        ...
        <circle cx="80%" cy="70%" r="40%" fill="url(#gradient2)" filter="url(#blur)">
          <animate attributeName="cx" values="85%; 65%; 85%" dur="20s" repeatCount="indefinite" />
          <animate attributeName="cy" values="70%; 65%; 70%" dur="24s" repeatCount="indefinite" />
        </circle>

        <circle cx="20%" cy="30%" r="35%" fill="url(#gradient1)" filter="url(#blur)">
          <animate attributeName="cx" values="15%; 35%; 15%" dur="18s" repeatCount="indefinite" />
          <animate attributeName="cy" values="30%; 35%; 30%" dur="22s" repeatCount="indefinite" />
        </circle>
        ...
        <ellipse
          ...
          opacity="0.3"
          filter="url(#blur)">
          <animate attributeName="cx" values="48%; 52%; 48%" dur="30s" repeatCount="indefinite" />
        </ellipse>
      </svg>
      ...
      <div className="relative z-10 min-h-screen flex flex-col items-center justify-center px-6 text-center">
        <div
          ...
          <FaHandSparkles
            Sparkles
            className={`w-4 h-4 ${isDark ? "text-cyan-400" : "text-blue-500"}`}
          />
        ...
        <div className="flex flex-col sm:flex-row gap-4 animate-fade-in-delay">
          <button
            className={`group px-8 py-4 bg-linear-to-r ${
              isDark
            ...
            Get Started
            <BiArrowToRight className="w-5 h-5 group-hover:translate-x-1 transition-transform" />
          </button>
...
<svg
        ...
        <defs>
          <linearGradient id="nightGradientBottom" x1="0%" y1="0%" x2="0%" y2="100%">
            <stop offset="0%" stopColor="#000000" />
            <stop offset="100%" stopColor="#4d34b1" />
          </linearGradient>
        </defs>

        <ellipse cx="500" cy="500" rx="1700" ry="490" fill="#7555f7" opacity="0.55" />
        <ellipse cx="500" cy="500" rx="1300" ry="450" fill="#3e2a8e" opacity="0.6" />
        <ellipse cx="500" cy="500" rx="1100" ry="420" fill="url(#nightGradientBottom)" />
      </svg>*/
